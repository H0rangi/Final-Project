  ...
  return (
    <div style={styles.container}>
      <div style={styles.textContainer}>
        ...
        <p>Check out our latest promotions and membership packages to find the perfect plan for you. We offer flexible membership options, including student discounts and referral bonuses.</p>
        <h2>Testimonials</h2>
